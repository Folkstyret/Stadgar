...
Folkstyret har autoveton som (1) innebär att Folkstyret automatiskt röstar nej till förslag som inte godkänns av lagrådet. Det innebär att förslag som är i strid med grundlagen, är diskriminerande, begränsar våra individuella friheter eller inte är kongruent med annan lagstiftning inte kan genomföras med Folkstyrets hjälp. Folkstyret kan alltså inte användas för att rösta bort demokratin, bara till att bredda och fördjupa den. Ett annat autoveto (2) triggas om ett förslag eller en omröstning har manipulerats så att Folkstyret inte har möjlighet att ta fram ett legitimt underlag till omröstningen. Till exempel om tiden som ges är för kort eller om någon försöker tvinga igenom ett beslut på ett för långt avstånd från medborgaren (att subsidiaritetsprincipen inte följs).
